...
from app.chatbot.models import ChatUser, Vehicle, Session
...
class BusinessService:
    ...
    def __init__(self):
        self.base_url = ChatbotConfig.API_BASE_URL
    ...
    def _send_block_command(self, vehicle: Vehicle, session: Session, comando: str) -> Tuple[bool, str]:
        try:
